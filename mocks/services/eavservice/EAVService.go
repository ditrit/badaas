...
func (_m *EAVService) GetEntity(ett *models.EntityType, id uint) (*models.Entity, error) {
	ret := _m.Called(ett, id)

	var r0 *models.Entity
	if rf, ok := ret.Get(0).(func(*models.EntityType, uint) *models.Entity); ok {
		r0 = rf(ett, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Entity)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*models.EntityType, uint) error); ok {
		r1 = rf(ett, id)
	} else {
		r1 = ret.Error(1)
	}
