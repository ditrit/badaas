...
import (
	...
	tabler "github.com/ditrit/badaas/badorm/tabler"
)

// CRUDRepository is an autogenerated mock type for the CRUDRepository type
type CRUDRepository[T tabler.Tabler, ID badorm.BadaasID] struct {
	mock.Mock
}
...
func NewCRUDRepository[T tabler.Tabler, ID badorm.BadaasID](t mockConstructorTestingTNewCRUDRepository) *CRUDRepository[T, ID] {
