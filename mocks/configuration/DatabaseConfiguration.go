...
// GetDialector provides a mock function with given fields:
func (_m *DatabaseConfiguration) GetDialector() configuration.DBDialector {
	ret := _m.Called()

	var r0 configuration.DBDialector
	if rf, ok := ret.Get(0).(func() configuration.DBDialector); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(configuration.DBDialector)
	}
